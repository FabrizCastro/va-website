        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-brand-primary hover:bg-brand-primary/90 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 group">
            ...
            <div className="glass-card rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              ...
              <div className="p-6 grid grid-cols-2 gap-4">
                ...
                <div className="bg-brand-dark/40 p-4 rounded-xl border border-white/5">
                  ...
                  <div className="flex items-end justify-between">
                    <h3 className="text-xl font-bold text-orange-400">S/ 18,340</h3>
                    <span className="text-[10px] text-slate-500">IGV/Renta</span>
                  </div>
                </div>
                <div className="col-span-2 bg-brand-dark/40 p-4 rounded-xl border border-white/5 h-48">
                  <HeroChart />
                </div>
                <div className="col-span-1 space-y-3">
                  <h4 className="text-[11px] font-bold text-slate-400 uppercase">Alertas SUNAT</h4>
                  <div className="flex items-center gap-3 p-2 rounded-lg bg-orange-500/5 border border-orange-500/20">
                    <div className="w-2 h-2 rounded-full bg-orange-500"></div>
                    <p className="text-[10px] text-orange-200">Presentación PDT 621</p>
                  </div>
                  <div className="flex items-center gap-3 p-2 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
                    <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                    <p className="text-[10px] text-emerald-200">Libros PLE validados</p>
                  </div>
                </div>
                <div className="col-span-1 bg-brand-dark/40 p-4 rounded-xl border border-white/5 flex flex-col items-center justify-center">
